...
class GroupsPage(BasePage):
    ...
    share_text = '//*[(@resource-id="android:id/content_preview_text" and contains(@text, "Hey! Join my group")) or (@resource-id="android:id/text1" and contains(@text, "Hey! Join my group"))]'
