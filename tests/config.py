...
text_250 = 'Social media has revolutionized the way we connect and communicate. With just a few taps on our devices,' \
...
text_1000 = 'Social media platforms have become ubiquitous in modern society, transforming the way we communicate, ' \
            'interact,' \
            'and consume information. With billions of users worldwide, these platforms serve as virtual arenas where' \
            ...
            'across' \
            'the globe. However, this interconnectedness also brings forth challenges, including issues of privacy, ' \
            'online' \
            'harassment, and the spread of misinformation. As algorithms tailor content to users preferences, ' \
            'echo chambers' \
            'form, reinforcing pre-existing beliefs and potentially fostering polarization. Moreover, the curated ' \
            'nature' \
            'of social media feeds can contribute to feelings of inadequacy and low self-esteem as individuals compare' \
...
test_user_login = 'conagriffeumme-2559@yopmail.com'
