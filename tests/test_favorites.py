...
class TestFavorites:
    ...
    def test_add_to_favorite(self, authorization):
        ...
        business_name = page.business.add_new_business(permission=False)
        ...
        ad_name = page.market.create_new_ad_stuff(permission=False)
        ...
        channel_name = page.channels.add_new_channel(permission=False)
        ...
        job_name = page.jobs.create_new_jobs(permission=False)
        page.add_to_favorite()
        page.favorites.favorite_btn_wait_color()
        page.click_back_btn()
        page.click_back_btn()
