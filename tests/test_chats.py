...
class TestChats:
    ...
    def test_place_chat(self, authorization):
        ...
        page.login.logout()
        page.login.authorization(test_user_login, test_user_password)
        place_name = 'Test Place_21034150'
        page.open_bottom_sheet()
        ...
        page.open_bottom_sheet_chut_chut()
        page.wait_a_second()
        page.wait_a_second()
        page.wait_a_second()
        page.wait_a_second()
        page.wait_a_second()
        page.wait_a_second()
        page.wait_element('//android.widget.TextView[@resource-id="com.yapmap.yapmap:id/name_text_view" and @text="Test Place_21034150"]')
        page.open_bottom_sheet()
